export const estToEngDict: Record<string, string> = {
    ...
    "Logi sisse, et luua mänge ja salvestada oma progress": "Log in to create games, play with friends & save your progress",
    "Logi sisse, et luua mänge, mängida sõpradega ja salvestada oma progress": "Log in to create games, play with friends & save your progress",
    "E-post": "E-mail",
    ...
    "Sõbrad": "Friends",
    "Kutsu sõber": "Invite Friend",
    "Kutsed": "Requests",
    "Sõbrakutsed (Friend Requests)": "Friend Requests",
    "Kutsu sõpru (Invite Friends)": "Invite Friends",
    "Mängijad / Players": "Players",
